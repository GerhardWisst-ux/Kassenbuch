...
<head>
    ...
    <title>CashControl - Benutzerhilfe Mandanten</title>
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-12 text-center mb-2 mb-md-0">
                        <h2 class="h4 mb-0">CashControl - Hilfe Mandanten</h2>
                    </div>
            ...
            <div class="custom-container">
                ...
                <div class="section">
                    ...
                    <ul>                        
                        ...
                        <li>Die Überschrift enthält den CashControl- Mandanten".</li>
                    </ul>
                </div>
                ...
                <div class="section">
                    ...
                    <ul>
                        <li><strong>+</strong> Button: Weiterleitung zu <code>AddKunde.php</code> zum Hinzufügen
                            eines
                            neuen
                            Mandanten.</li>
                ...
                <div class="section">
                    ...
                    <ul>
                        ...
                        <li>Nach Bestätigung wird ein verstecktes Formular mit ID und CSRF-Token an
                            <code>DeleteKunde.php</code> gesendet.
                        </li>
                        <li>Nach erfolgreicher Löschung erscheint ein Toast, dass der Mandant gelöscht wurde.</li>
                    </ul>
                </div>
                ...
                <div class="section">
                    <h2>7. Sicherheit</h2>
                    <ul>
                        <li>Nur ADMIN's können Mandanten sehen oder bearbeiten.</li>
                ...
                <div class="section">
                    <h2>8. Ablaufdiagramm Mandanten</h2>
                    <div class="flowchart">
                        <div class="step">Seite laden</div>
                        <div class="arrow"></div>
                        <div class="step">Daten aus Tabelle <code>kunden</code> laden</div>
                        <div class="arrow"></div>
                        ...
                        <div class="arrow"></div>
                        <div class="step">Mandant wird gelöscht → Toast-Benachrichtigung</div>
                    </div>
                </div>
                <p class="mt-4">
                    <a href="../Mandanten.php" class="btn btn-secondary">
                        <i class="fa fa-arrow-left"></i> Zurück zur Mandanten-Verwaltung
                    </a>
                </p>
