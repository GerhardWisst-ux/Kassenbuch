...
<head>
    ...
    <title>CashControl - Benutzerhilfe User</title>
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-12 text-center mb-2 mb-md-0">
                        <h2 class="h4 mb-0">CashControl - Hilfe User</h2>
                    </div>
            ...
            <div class="custom-container">
                ...
                <div class="section">
                    ...
                    <ul>                        
                        ...
                        <li>Die Überschrift enthält den CashControl- User".</li>
                    </ul>
                </div>
                ...
                <div class="section">
                    <h2>7. Sicherheit</h2>
                    <ul>
                        <li>Nur ADMIN's können User sehen oder bearbeiten.</li>
                ...
                <div class="section">
                    <h2>8. Ablaufdiagramm User</h2>
                    <div class="flowchart">
                        <div class="step">Seite laden</div>
                        <div class="arrow"></div>
                        <div class="step">Daten aus Tabelle <code>users</code> laden</div>
                        <div class="arrow"></div>
                        ...
                        <div class="arrow"></div>
                        <div class="step">User wird gelöscht → Toast-Benachrichtigung</div>
                    </div>
                </div>
                <p class="mt-4">
                    <a href="../Users.php" class="btn btn-secondary">
                        <i class="fa fa-arrow-left"></i> Zurück zur User-Verwaltung
                    </a>
                </p>
