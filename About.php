...
<body>
    ...
    <div class="topnav" id="myTopnav">
        ...
        <a class="active" href="About.php">Über</a>
        ...
        <form id="bestaendeform">
            <div class="custom-container">
                ...
                <div class="custom-container">
                    ...
                    <p class="me-4"><strong>Das Kassenbuch wurde 2025 erstellt<br>
                            Author : Gerhard Wißt<br>
                            Langjährige Programmiererfahrung unter .NET,ASP.NET, C#, VB.NET, PHP, Blazor, Webtechnologien und SQL-Server. <br> Erstellt Webanwendungen und datenbankgestützte Applikationen
                        </strong>
                    </p>
                    <p class="me-4" style="text-align:left">
